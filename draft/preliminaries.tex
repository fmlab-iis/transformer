...
\end{equation*}
<<<<<<< HEAD
\todo{no computation means terminate normally? I think yes.}
...
\textsc{Blast}, \textsc{UFO}, \textsc{} \todo{more? SLAM is not recursion-free}. Our goal is to check
