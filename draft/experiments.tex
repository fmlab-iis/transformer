...
In addition, because \textsc{CPAChecker} does not support universal quantifiers in the expression of an $\mathtt{assume}$ command, we used Redlog~\cite{redlog} for quantifier elimination on
logic formulae.
