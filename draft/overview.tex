  ...
  \begin{subfigure}[b]{.3\textwidth}
    \begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node
      ...
      \path
        ...
        (2) edge 
            node [left] {$\mathtt{assert\ ret^{mc91}_0 >= 91}$} (3)
        (3) edge 
            node [left] {$\mathtt{ret^{main}_0 := 0}$} (4);
    \end{tikzpicture}
  ...
  \begin{subfigure}[b]{.6\textwidth}
    \begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node
      ...
      \path
        ...
        (3) edge 
            node [right] {$\mathtt{s := ret^{mc91}_0}$} (4)
        (4) edge [bend left=30]
            node [right] {$\mathtt{assume\ false}$} (5);
    \end{tikzpicture}
...
\begin{figure}
  \centering
    \begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node
      distance=2cm,thick,node/.style={circle,draw}]
      \node[node] (s) at ( 0,  0) {$\ell_s$};
      \node[node] (1) at (-1, -2) {$\ell_1$};
      \node[node] (2) at ( 1, -0.8) {$\ell_2$};
      \node[node] (3) at ( 1, -2) {$\ell_3$};
      \node[node] (4) at ( 1, -3.2) {$\ell_4$};
      \node[node] (e) at ( 0, -4) {$\ell_e$};

      \node[node] (s') at ( 5,  2.0) {$\ell_{s'}$};
      \node[node] (1') at ( 4,  0.0) {$\ell_{1'}$};
      \node[node] (2') at ( 6,  1.2) {$\ell_{2'}$};
      \node[node] (3') at ( 6,  0.0) {$\ell_{3'}$};
      \node[node] (4') at ( 6, -1.2) {$\ell_{4'}$};
      \node[node] (e') at ( 5, -2) {$\ell_{e'}$};

      \node[node] (s'') at ( 5, -3.2) {$\ell_{s''}$};
      \node[node] (1'') at ( 4, -5.2) {$\ell_{1''}$};
      \node[node] (2'') at ( 6, -4.0) {$\ell_{2''}$};
      \node[node] (3'') at ( 6, -5.2) {$\ell_{3''}$};
      \node[node] (4'') at ( 6, -6.4) {$\ell_{4''}$};
      \node[node] (e'') at ( 5, -7.2) {$\ell_{e''}$};
      ...
      \path
        ...
        (1) edge [bend right=30]
            node [left] {$\mathtt{ret^{mc91}_0 := m - 10}$} (5)
        (2) edge [bend left=45]
            node [left] {$\mathtt{m' := m + 11}$} (s')
        (3) edge 
            node [right] {$\mathtt{s := ret^{mc91}_0}$} (4)
        (4) edge 
            node [above] {$\mathtt{m'' := s}$} (s'')
        ...
        (2') edge 
             node [right] {$\mathtt{mc91(m'+11)}$} (3')
        (3') edge 
             node [right] {$\mathtt{s' := ret^{mc91}_0}$} (4')
        (4') edge [bend left=30]
            node [right] {$\mathtt{mc91(s')}$} (e')
        (e') edge
             node        {$\mathtt{skip}$} (3)
